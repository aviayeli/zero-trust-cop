...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1705 tests
  passing**.
...
└── tests/                       # 1705 tests, mirroring the src/ layout
```
...
**1705 passing tests**. The load-bearing cases, by layer:
