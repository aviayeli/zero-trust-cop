...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1457 tests
  passing**.
...
└── tests/                       # 1457 tests, mirroring the src/ layout
```
...
**1457 passing tests**. The load-bearing cases, by layer:
