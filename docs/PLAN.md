...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1445 tests
  passing**.
...
└── tests/                       # 1445 tests, mirroring the src/ layout
```
...
**1445 passing tests**. The load-bearing cases, by layer:
