...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1687 tests
  passing**.
...
└── tests/                       # 1687 tests, mirroring the src/ layout
```
...
**1687 passing tests**. The load-bearing cases, by layer:
