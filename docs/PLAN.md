...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1703 tests
  passing**.
...
└── tests/                       # 1703 tests, mirroring the src/ layout
```
...
**1703 passing tests**. The load-bearing cases, by layer:
