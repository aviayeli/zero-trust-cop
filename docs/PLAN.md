...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **920 tests
  passing**.
...
└── tests/                       # 920 tests, mirroring the src/ layout
```
...
**920 passing tests**. The load-bearing cases, by layer:
