...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **910 tests
  passing**.
...
└── tests/                       # 910 tests, mirroring the src/ layout
```
...
**910 passing tests**. The load-bearing cases, by layer:
