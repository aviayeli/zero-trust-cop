...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **1167 tests
  passing**.
...
└── tests/                       # 1167 tests, mirroring the src/ layout
```
...
**1167 passing tests**. The load-bearing cases, by layer:
