...
- **Strict TDD**: every module below was specified precisely enough that a
  failing test could be written before it existed. Current state: **850 tests
  passing**.
...
└── tests/                       # 850 tests, mirroring the src/ layout
```
...
**850 passing tests**. The load-bearing cases, by layer:
