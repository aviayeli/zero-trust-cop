...
The system is evidenced rather than asserted: **1668 tests**, a mechanically
...
| Discipline | State |
|---|---|
| Test suite | **1668 tests**, all passing (unit → live two-process HTTP) |
