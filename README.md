...
The system is evidenced rather than asserted: **1457 tests**, a mechanically
enforced 150-line ceiling on every one of the **321** tracked Python files, and
...
| Discipline | State |
|---|---|
| Test suite | **1457 tests**, all passing (unit → live two-process HTTP) |
| Line limit | every one of the **321** tracked Python files ≤ **150 lines** (max: 150) |
