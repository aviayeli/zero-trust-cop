...
| Discipline | State |
|---|---|
| Test suite | **1150 tests**, all passing (unit → live two-process HTTP) |
| Line limit | every one of the **238** tracked Python files ≤ **150 lines** (max: 149) |
