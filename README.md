...
| Discipline | State |
|---|---|
| Test suite | **1161 tests**, all passing (unit → live two-process HTTP) |
| Line limit | every one of the **242** tracked Python files ≤ **150 lines** (max: 149) |
