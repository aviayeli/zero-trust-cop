...
| Discipline | State |
|---|---|
| Test suite | **914 tests**, all passing (unit → live two-process HTTP) |
| Line limit | every one of the **192** tracked Python files ≤ **150 lines** (max: 149) |
...
# expected: 914 passed
# actually prints "913 passed, 1 skipped": one test in
